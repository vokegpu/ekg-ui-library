...
void ekg::ui::scrollwidget::on_destroy() {
}

void ekg::ui::scrollwidget::on_reload() {
...
void ekg::ui::scrollwidget::on_pre_event(SDL_Event &sdl_event) {
...
void ekg::ui::scrollwidget::on_event(SDL_Event &sdl_event) {
